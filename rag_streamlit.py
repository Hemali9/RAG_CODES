...
Original file is located at
    https://colab.research.google.com/drive/1UuV1-2kpt-g73DZ3GytJe5m48r2niKda
...
os.environ["GOOGLE_API_KEY"] = userdata.get("G_API_KEY")
...
ngrok.set_auth_token(userdata.get('NGROK_API'))
